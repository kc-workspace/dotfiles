...
## [0.9.0](https://github.com/kc-workspace/dotfiles/compare/v0.8.0...v0.9.0) (2026-08-18)
...
* **ai:** add gemini feature flag integration ([c2d900e](https://github.com/kc-workspace/dotfiles/commit/c2d900ea213948dcf7426c826d8e0c821fbf0f4c))
...
* **codex:** add codex feature flag for config and hooks ([39bbe11](https://github.com/kc-workspace/dotfiles/commit/39bbe11746db2444f572e660bf2beb1e03c60b2d))
...
* **copilot:** add support for Copilot feature flags and hooks ([0cc6edf](https://github.com/kc-workspace/dotfiles/commit/0cc6edf2f5601097730b3cab636a20a62fccf512))
...
* **feature-flags:** add ai::claude:enable ([430545f](https://github.com/kc-workspace/dotfiles/commit/430545f530a3196e4aaf7929131673bd0c2df859))
* **feature-flags:** add mode-aware include rendering ([f6c7af2](https://github.com/kc-workspace/dotfiles/commit/f6c7af2cbafe9f1818913ed224f7b90de1a7d6a4))
* **featureFlag:** add 2 more flags: kube::personal:config and kube::stm:config ([c63a531](https://github.com/kc-workspace/dotfiles/commit/c63a53132adad698fe999441556f07ee45f8759b))
* **featureFlag:** add 4 new flags for ssh:: ([303c3bd](https://github.com/kc-workspace/dotfiles/commit/303c3bdd4b1b94c89c34cdf8194b845b776d7518))
* **featureFlag:** add flag for github ssh and git signing key ([028c529](https://github.com/kc-workspace/dotfiles/commit/028c5297240ca245a8bfa5565e3f64c10fafdfa5))
* **featureFlag:** add git::personal:config, and git::stm:config template for personal and works config ([845f9b5](https://github.com/kc-workspace/dotfiles/commit/845f9b564a7e2165539bac3507f8f96ede12d91b))
* **featureFlag:** add new homepi flags ([7179ab8](https://github.com/kc-workspace/dotfiles/commit/7179ab89ec68256c4fd5f5fcd37e85779ed89bc8))
* **featureFlag:** add support for ssh::onepassword:config flag ([7142977](https://github.com/kc-workspace/dotfiles/commit/714297740d19d82929b19c2fe748cf613efb323d))
* **featureFlags:** add aws-vpn::stm:config flag for aws-client-vpn config ([793da2d](https://github.com/kc-workspace/dotfiles/commit/793da2daa70d9d64c3f47a466093d60d2265b6dc))
* **featureflags:** add nvim and zinit install hooks ([e50a7c6](https://github.com/kc-workspace/dotfiles/commit/e50a7c691b244505be35fc5b742970ccb3da3264))
* implement 3 new featureFlags on git:: ([4b9fb41](https://github.com/kc-workspace/dotfiles/commit/4b9fb41c0be28c1353a200abc79cdf0647cc4d31))
* implement kdf-verify.sh script ([1e476b0](https://github.com/kc-workspace/dotfiles/commit/1e476b01b3e11a84d5229760965027a1af3e358c))
* **kdf-verify:** modularize verification helpers and expand checks ([fdfbffb](https://github.com/kc-workspace/dotfiles/commit/fdfbffba1b419b04b3ffe50181ee987b138c7930))
* **kdf:** split setup into full and lite workflows ([deab536](https://github.com/kc-workspace/dotfiles/commit/deab536003ffe401c0e589c9e7ae6eadf5e46359))
* **kdf:** support configurable chezmoi runs ([72a7983](https://github.com/kc-workspace/dotfiles/commit/72a7983e0a0640655f8537bf203c2987f9e0492d))
...
* **machine.darwin:** add control center, hot corners, window manager, and spaces settings ([5570a2b](https://github.com/kc-workspace/dotfiles/commit/5570a2bb31f8177a39fbbca5d07c179ecc7bf432))
...
* move featureFlag content from template to .content directory ([749ef85](https://github.com/kc-workspace/dotfiles/commit/749ef85c003db28a542cfcd0e15828e211f7900f))
* **script:** add missing zinit source to kdf-utils ([b26a0ea](https://github.com/kc-workspace/dotfiles/commit/b26a0ea17d1312b9a15c247d45626592e692f6fc))
...
* **script:** first draft of kdf-setup.sh script ([6c08103](https://github.com/kc-workspace/dotfiles/commit/6c081036ea64ea049c2eb596cb9f31d4dea88725))
...
* **skills:** add feature-flag-integration workflow ([feb6153](https://github.com/kc-workspace/dotfiles/commit/feb61530742141814061b049aa2d070e1fc62143))
* support disable age decrypt and/or 1pass fetch ([9a7fbe1](https://github.com/kc-workspace/dotfiles/commit/9a7fbe10a6b2232ea09cf95aa31894092f5da199))
...
* sync mise config from dest directory ([fa02556](https://github.com/kc-workspace/dotfiles/commit/fa025562f90f245752cc0cb6f8890388368a3961))
* **template:** add format helper for output formatting in feature flags ([7d1f0be](https://github.com/kc-workspace/dotfiles/commit/7d1f0be36ee59b8e8d523293b37564133202c671))
...
* **template:** add includeOnly helper for flag evaluation ([1d87672](https://github.com/kc-workspace/dotfiles/commit/1d876725b6379c916651a60a5cdd848c8c0cc8bc))
...
* **warp:** drive workspace aliases from feature flags ([9e7fccc](https://github.com/kc-workspace/dotfiles/commit/9e7fccc65daf75691c04e6c3ee7ba6458d483c90))
* **zsh:** update aliases for lsd (l, la, and tree) ([c765253](https://github.com/kc-workspace/dotfiles/commit/c7652530a10be28ab1e6f350be6bc510d79a15dd))


### Bug Fixes

* `brew bundle install --quiet` cause ci to flaky ([938d66d](https://github.com/kc-workspace/dotfiles/commit/938d66d465e7a09367a254ce47bf7d719ba1651a))
* change chezmoi init option from --verbose to --debug for better troubleshooting ([a5563c8](https://github.com/kc-workspace/dotfiles/commit/a5563c8d192066ea3c7978ef8e8966d8074167fc))
...
* **chezmoi:** harden CI env check and remove shell tracing ([426189c](https://github.com/kc-workspace/dotfiles/commit/426189c45b60ec291cea9342d368fdf4d611ab47))
* **chezmoi:** replace override arrays instead of concat ([bab4f76](https://github.com/kc-workspace/dotfiles/commit/bab4f76e71b385fe31ee9caa9c19bca7d9517489))
* **ci:** run kdf tasks with zsh shell ([908a789](https://github.com/kc-workspace/dotfiles/commit/908a78931798d89009f728e474128b3a15025a4d))
* **cleanup:** replace chezmoi destroy with chezmoi purge in cleanup script ([49f5b54](https://github.com/kc-workspace/dotfiles/commit/49f5b546eb1d97c9ad90b9d54bf833fd21df1d60))
...
* correct function name from mise_activate to _mise_activate in cleanup scripts ([9ac4be7](https://github.com/kc-workspace/dotfiles/commit/9ac4be7ca740f59a1cabf0caae9a3bfb52813016))
* **data:** I install the beta version :sorry: ([bbd6dd1](https://github.com/kc-workspace/dotfiles/commit/bbd6dd1ea0350c2df8dc34ab014b6d9346cfe50d))
* **data:** latest changes cause apt and apk to always run ([2c0cc54](https://github.com/kc-workspace/dotfiles/commit/2c0cc54e8585a766a2325a6527d37b74c780657c))
* **data:** pin brave origin in dock instead ([617c1fd](https://github.com/kc-workspace/dotfiles/commit/617c1fd8615c636d99df09755bdc8b33f3481845))
* **docker:** add build-base to alpine as required by python-build in mise ([81e859f](https://github.com/kc-workspace/dotfiles/commit/81e859ffd05f946597e95de4473f4ea1b7a497e9))
* **docker:** add dependencies for compile python in docker ([a9afd08](https://github.com/kc-workspace/dotfiles/commit/a9afd082ba7f2a940fb28006b455b9183da359ca))
* **docker:** add missing deps recommended by brew ([e89cab8](https://github.com/kc-workspace/dotfiles/commit/e89cab815ecaf1c2b1443a81dbc4c51017e35a8f))
* **docker:** alpine missing bash command ([3b2f97e](https://github.com/kc-workspace/dotfiles/commit/3b2f97ee80a5b833bbfd76b93cee47b3ab2c6a23))
* **docker:** missing sudo apk ([a9b71dc](https://github.com/kc-workspace/dotfiles/commit/a9b71dc933d3b30439f8b4b1189723856522a412))
* **docker:** try brew install with prefetch ([b94feeb](https://github.com/kc-workspace/dotfiles/commit/b94feeb3700f05d10075277f8779d4b9ad7f84af))
* **docker:** update dependency installation in Dockerfile for clarity ([8eec186](https://github.com/kc-workspace/dotfiles/commit/8eec1869d88d55da04d47c0384bbf9a6a4d94914))
* **docker:** update Dockerfile to improve package installation and caching ([52321aa](https://github.com/kc-workspace/dotfiles/commit/52321aa7398f1197371dc6fd6311821a7bf729d5))
* **docker:** use full path when execute kdf-* script on docker ([703161b](https://github.com/kc-workspace/dotfiles/commit/703161b79e59dd070258f5f6d835f547ad51173a))
* ensure mise is activated in _main function and remove duplicate activation in _verify_mise ([a9ac3d8](https://github.com/kc-workspace/dotfiles/commit/a9ac3d8d4759f06c99453dbb225398b4c42453fc))
...
* **flags:** add flavor configuration for unofficial Node.js builds ([d58bbe6](https://github.com/kc-workspace/dotfiles/commit/d58bbe6be69bcfb0ea0555937394a66e82a32e0a))
* format serena-hooks.json for consistency ([0f2bcf5](https://github.com/kc-workspace/dotfiles/commit/0f2bcf51dc02c9bd054d33df91da76a2e8635dcb))
...
* **kdf-utils:** activate brew before verifying its version ([9c05473](https://github.com/kc-workspace/dotfiles/commit/9c054738dc578b9709d8d48fc53f3560ef2f29ef))
* **kdf-utils:** improve brew command detection order in _brew function ([11f5a4f](https://github.com/kc-workspace/dotfiles/commit/11f5a4f2d6c3d2211b912ddccae9754afeb53cdf))
* **kdf-utils:** use templated brew helper in verify flow ([a1398c3](https://github.com/kc-workspace/dotfiles/commit/a1398c318a010b3b6356b2f8b444fcb342b60070))
* key.txt.age should be in chezmoi source dir, not root ([bf9ec61](https://github.com/kc-workspace/dotfiles/commit/bf9ec61436a757c73de3906a6aca7afcdfbf99d8))
* **linux:** gpg in debian based should use gnupg instead of gpg ([afb66b0](https://github.com/kc-workspace/dotfiles/commit/afb66b0e6be18772e235c140f8a534eb676b315e))
* newline + indent didn't quite right ([4814a4e](https://github.com/kc-workspace/dotfiles/commit/4814a4e180c076b9b9a0e8b4eae6a4e7f51a4b79))
...
* remove sandbox warning from actions ([00ab835](https://github.com/kc-workspace/dotfiles/commit/00ab83570a53494ae44cd396d868bb624913cb34))
* remove unnecessary punctuation in bubblewrap comment for clarity ([5f81fcf](https://github.com/kc-workspace/dotfiles/commit/5f81fcffca8ce079c56612db9fe39a184bce8428))
* **script:** apt and apk will run even if packages is empty depends on auto* setting ([dbc6ae2](https://github.com/kc-workspace/dotfiles/commit/dbc6ae21a0ad3c44e1b76a8d868a49398c607ff3))
...
* **script:** dockutil didn't reset all apps from plist, and fix typo ([39109f5](https://github.com/kc-workspace/dotfiles/commit/39109f5a3b03f0753c99663cee4b2dbc5bd7c82f))
* **script:** ensure installation message for Homebrew is displayed correctly ([bde202a](https://github.com/kc-workspace/dotfiles/commit/bde202ac8ab2db4f1849395444bef3c998a695e9))
* **script:** handle GITHUB_ACTIONS variable safely in decrypt-private-key script ([ee5d553](https://github.com/kc-workspace/dotfiles/commit/ee5d553a85dc5377e959dd13b5f1c020f7421b92))
* **script:** improve logging for nvim sync and install processes ([c2f3701](https://github.com/kc-workspace/dotfiles/commit/c2f3701ce088b5ec774cb9f5281015218d34a596))
* **script:** incorrect args order on dockutil command ([dd0dd30](https://github.com/kc-workspace/dotfiles/commit/dd0dd30cde8d2ecb97df20be2ed70ea30a8b1607))
* **script:** invalid defaults value for setting in example file ([5d6d066](https://github.com/kc-workspace/dotfiles/commit/5d6d06655cc2401b1b45ba4b245ad6a04810635f))
...
* **script:** kdf-verify will try to load brew env before execute ([51f51e0](https://github.com/kc-workspace/dotfiles/commit/51f51e0cffa4f85101e7386c1f304b86cbcd38d5))
...
* **script:** mas reset is optional, if might fail if not cache available locally ([f381c57](https://github.com/kc-workspace/dotfiles/commit/f381c574097ef96f4a7967eae668e5437320ede8))
* **script:** missing new kdf-utils/brew.sh ([5a7b384](https://github.com/kc-workspace/dotfiles/commit/5a7b38469d3b77110fcfe61ed3456d84b9983da7))
* **script:** missing space between custom args in dockutil cli ([349e9ae](https://github.com/kc-workspace/dotfiles/commit/349e9aef55220bc32c675cf13f08e93c6d4960da))
...
* **script:** remove --quiet flag from mise install commands for better visibility ([8caafa7](https://github.com/kc-workspace/dotfiles/commit/8caafa7e4a05586cda5868550c49f8412d876950))
...
* **script:** update featureflag-nvim script to output correct message ([2904e05](https://github.com/kc-workspace/dotfiles/commit/2904e05478682279d8d149ec5dddf449b4badb9c))
* **script:** use pipe instead of stdout redirection ([b0ed8c6](https://github.com/kc-workspace/dotfiles/commit/b0ed8c605bbd59cf06774cdc4ff31e5271d5ae81))
* **script:** verify brew doctor should be optional ([052dbe7](https://github.com/kc-workspace/dotfiles/commit/052dbe77b8a7169494e450eb43cc4f07017d1d2e))
* **script:** when brew autoinstall is enable, but no packages defined script will be fails ([15e5176](https://github.com/kc-workspace/dotfiles/commit/15e5176aef0d45167a07a6d7e0af47171618a7af))
* **script:** zshrc should not contains brew command check as brew is optional ([acdd193](https://github.com/kc-workspace/dotfiles/commit/acdd193627d6c7ad19455ced7a528d60f163b826))
* set -o pipefail didn't support on github actions ([10df25d](https://github.com/kc-workspace/dotfiles/commit/10df25d08ac2bd98364e9a31126f6e473b1b737a))
...
* streamline brew command handling in dependencies script ([fdde6ad](https://github.com/kc-workspace/dotfiles/commit/fdde6ad8b113c214bd32ca90d6184d8346670d93))
* **template:** featureFlags/internal/get selector check didn't returns correct result ([8933747](https://github.com/kc-workspace/dotfiles/commit/8933747e1bfffa2f3c99fb182e8b785be638664e))
* **template:** simplify isDisable helper by removing unnecessary context and flag handling ([d8940ff](https://github.com/kc-workspace/dotfiles/commit/d8940ff1ece92f8b5de3de2ad6b7d0ec8798747d))
* **template:** up to date template in warprc ([a0986f3](https://github.com/kc-workspace/dotfiles/commit/a0986f3b1bd9669195a0d98542e182a26301334a))
* **template:** wrong helper name cause inf loop ([611f07d](https://github.com/kc-workspace/dotfiles/commit/611f07d30b320940c3e5e893936e99310461afd5))
* to use unofficial-builds, your compile must be false ([e6f2f6b](https://github.com/kc-workspace/dotfiles/commit/e6f2f6b2224acd99c03f43e1d47882afd178c904))
* **ubuntu:** install git package by default ([d599c29](https://github.com/kc-workspace/dotfiles/commit/d599c2919137a12e4ee05bdc7860f5aec83496a5))
* up to date .gitconfig file ([7f56b72](https://github.com/kc-workspace/dotfiles/commit/7f56b721c293e94d48afdb3e1b52c2404520df60))
* update due to behavior changes ([c5de3e3](https://github.com/kc-workspace/dotfiles/commit/c5de3e32345bf22c0e6c3342081d97332a53b3a1))
* update private_settings.json for improved configuration options ([774310f](https://github.com/kc-workspace/dotfiles/commit/774310f97a0826d25e74460fdf4772cfedce4edf))
...
* **data:** install brave origin as default browser instead ([8e4a24e](https://github.com/kc-workspace/dotfiles/commit/8e4a24e12e7a043d21d4cf9e398985aa745beab8))
* **data:** move dependencies to dockerfile instead for better caching ([0aa0fc4](https://github.com/kc-workspace/dotfiles/commit/0aa0fc4f8f4850db469b010a98991a63b47f95fd))
...
* **deps:** upgrade chezmoi from v2.70.0 to v2.70.5 ([134fa56](https://github.com/kc-workspace/dotfiles/commit/134fa56b4656201c091ea47797cb618eccd174a1))
...
* **deps:** upgrade tools in mise to latest version ([21b60ce](https://github.com/kc-workspace/dotfiles/commit/21b60ce98316871c2c7905c515923cd391046a74))
* **docker:** add unoffical-builds for alpine docker ([4f8cc21](https://github.com/kc-workspace/dotfiles/commit/4f8cc21aab121d126f4b05ebbd3f5345ea30d521))
* **docker:** don't uninstall builds lib so what it make image a bit larger, but easier to use and debug ([cc06da7](https://github.com/kc-workspace/dotfiles/commit/cc06da7272171f931297fb6d3038d2eaa8417d66))
...
* enable age and 1password after run kdf-setup.sh ([be68622](https://github.com/kc-workspace/dotfiles/commit/be686221101416df3a86f3adea029bf61b5bf8c1))
* **featureFlag:** add ssh::stm:config to enable stm config on ssh ([6886b83](https://github.com/kc-workspace/dotfiles/commit/6886b832826006d95f824eaa1558f9d921382da8))
* **featureFlag:** use age to encrypt public key instead of fetch from 1p ([386f235](https://github.com/kc-workspace/dotfiles/commit/386f23535f61a30b69c9364cf56d6a020ab14efc))
...
* improve mise main config ([8ea7b6f](https://github.com/kc-workspace/dotfiles/commit/8ea7b6fde1abfd973e8906abbb8b1d188d380d88))
...
* **mise:** missing log only show on machine profile ([a35b39a](https://github.com/kc-workspace/dotfiles/commit/a35b39ad841d1d71dac3b47478d49f6e1e604da6))
...
* move some basic featureFlag to base featureFlags ([3366f18](https://github.com/kc-workspace/dotfiles/commit/3366f18b7c2ca2b8b19b7568320f5f50571a6cc4))
...
* **script:** add --quiet to mise install cmd ([133a9e5](https://github.com/kc-workspace/dotfiles/commit/133a9e519f8205a5eec29ee2fad5f09a23434511))
...
* **script:** add log when private key existed ([f7e4216](https://github.com/kc-workspace/dotfiles/commit/f7e4216aa3baeaed6a837bd94a442a915ad269ec))
* **script:** add neovim verify on kdf-verify.sh ([d191287](https://github.com/kc-workspace/dotfiles/commit/d191287bfa074165c403734cf8bff4bdf1430057))
...
* **script:** if autoinstall brew is enable, execute brew script ([841c4c4](https://github.com/kc-workspace/dotfiles/commit/841c4c48402990252321cfb1a41f3bce1d66e637))
* **script:** improve kdf-verify to finish all before exit with error ([0dfd6ec](https://github.com/kc-workspace/dotfiles/commit/0dfd6ec79144983ce85edf0e952a77c723e08dbf))
* **script:** kdf-verify is back to check mise doctor and make actions to install all tools by default ([478fc55](https://github.com/kc-workspace/dotfiles/commit/478fc558c57bbcb6de5e0dc8003dbb965b9ed835))
* **script:** mise doctor in kdf-verify.sh no longer require to pass ([a584618](https://github.com/kc-workspace/dotfiles/commit/a5846182c2fa907272d1f7c1d53c77f8b7d9b5c0))
* **script:** mise must be available for kdf-* script ([6b00577](https://github.com/kc-workspace/dotfiles/commit/6b00577e6297fe6a7e45fec4178f2e640fcab7f1))
...
* **script:** only decrypt age key only if settings.age is true ([7453f85](https://github.com/kc-workspace/dotfiles/commit/7453f851a0106951c46b953dafcb921edcadd859))
* **script:** op and gh is optional cli ([1c359ad](https://github.com/kc-workspace/dotfiles/commit/1c359ad8f10f3cda53fad5a30af704a4e19ef194))
...
* **script:** reduce noise log on install scripts ([d742a51](https://github.com/kc-workspace/dotfiles/commit/d742a512553813349068db76a217894f1adce4d1))
* **script:** support use env for key.txt additionally to the manual age decrypt ([cb5b657](https://github.com/kc-workspace/dotfiles/commit/cb5b657637c14b9ac6c99f929c3a6f170f52728d))
...
* support mustEnable helper to immediately returns empty if featureFlag is not enable ([2ea2bc3](https://github.com/kc-workspace/dotfiles/commit/2ea2bc35ed44b5f782b682cfc723c8961c681b4e))
...
* **template:** add brew on actions and docker too ([9590be7](https://github.com/kc-workspace/dotfiles/commit/9590be7a3490a3c751e138b9aef4ac2b8d3e83c6))
...
* **template:** all global/helpers/is* will work with if without mustFromJson helper ([a9ce70f](https://github.com/kc-workspace/dotfiles/commit/a9ce70f945955175b5251de8809a0df7ba214d23))
* **template:** getData will merge data with overrides when use parent path ([22325d0](https://github.com/kc-workspace/dotfiles/commit/22325d0af52783f1b9e762f606a2ea4c050645e1))
* **template:** migrate public bitbucket and gitlab ssh key to age encryption ([e4655a2](https://github.com/kc-workspace/dotfiles/commit/e4655a2a9d3b1b6b9ce44b47989f323f8c684494))
* **template:** move featureFlags/helpers/get to internal ([b5a6309](https://github.com/kc-workspace/dotfiles/commit/b5a6309008132092aead56f829915e777d1be4fd))
* **template:** move internal helper on featureFlags to internal directory instead ([4305e90](https://github.com/kc-workspace/dotfiles/commit/4305e90727c32de0beb14c0fb4e0e0ffdc4e6cd6))
* **template:** prepare for selector ([d2bad77](https://github.com/kc-workspace/dotfiles/commit/d2bad775cad3ffb6d4e444fc66c15acbc24c369a))
* **template:** separate file parse and support custom file name selector ([07cf199](https://github.com/kc-workspace/dotfiles/commit/07cf199adffbd11903b7a1a1aedec9ea9faa1acb))
* **template:** support 1password agent for ssh::stm:config flag ([67fce74](https://github.com/kc-workspace/dotfiles/commit/67fce74f12826b439de1807a4178e56dcf61c6fa))
* **template:** support custom indentKey on global/helpers/format ([e1f3bff](https://github.com/kc-workspace/dotfiles/commit/e1f3bff185287a0e07c29de39e60c6249cacc97d))
* **template:** support disable age and 1password data ([6e7eaf5](https://github.com/kc-workspace/dotfiles/commit/6e7eaf5578ab6e790324bdebcd84b94eb8603feb))
...
* **zsh:** update alias czy will no longer init config, use czyi instead ([33cf7b7](https://github.com/kc-workspace/dotfiles/commit/33cf7b74362be8fdd9314ed012beefc8d3bcf868))
