...
## [0.8.0](https://github.com/kc-workspace/dotfiles/compare/v0.7.0...v0.8.0) (2026-07-01)
...
* add decrypt private key script before everything ([05e34b8](https://github.com/kc-workspace/dotfiles/commit/05e34b87fd6d0ccc227f3291c78f590400cd80a1))
...
* **chezmoi:** add dependency scripts for new schema ([7da34c3](https://github.com/kc-workspace/dotfiles/commit/7da34c30d6af190b5fe028cef80b987e58182b88))
* **chezmoidata:** migrate actions ubuntu deps schema ([0c833ed](https://github.com/kc-workspace/dotfiles/commit/0c833ed6adfd6e70bb4e45da336373a5fa234e2e))
* **chezmoidata:** migrate docker deps schema ([7d75005](https://github.com/kc-workspace/dotfiles/commit/7d75005eb582b36f43c3abde9bf6f1e0632753d0))
* **chezmoi:** implement mas dependency script ([e111d48](https://github.com/kc-workspace/dotfiles/commit/e111d48e7d1fe492895d964e20162c52dca9c129))
* **chezmoi:** implement preferences-defaults script for macOS ([d9e3d12](https://github.com/kc-workspace/dotfiles/commit/d9e3d120791261e91e041219ddf6929d79cb4ab6))
* **codex:** add notchbar agent status hooks ([6f087cb](https://github.com/kc-workspace/dotfiles/commit/6f087cb2a3c6a22d793066f87487af5303c988ca))
...
* **copilot:** add footer display settings ([9a61cd4](https://github.com/kc-workspace/dotfiles/commit/9a61cd44f7febadd71e0c932f24ff2028b777971))
* **data:** support featureFlags setting and definition how to get featureFlag content ([1bbe5a7](https://github.com/kc-workspace/dotfiles/commit/1bbe5a719a66f293ac57afd2ffdb71ae7e7cf0ce))
* **encryption:** switch from GPG to AGE for encryption and add key file ([29200c0](https://github.com/kc-workspace/dotfiles/commit/29200c0339b8b18ce07015e2e198cfda0b754789))
...
* **script:** implement dependencies and remove empty script when no config ([4fd6253](https://github.com/kc-workspace/dotfiles/commit/4fd6253ab28d12ada35bb65e4ec8a6a002f97ccc))
...
* **script:** migrate mise set up script ([3aadaf7](https://github.com/kc-workspace/dotfiles/commit/3aadaf77420a5dceb70a81c15deff71769cde70b))
...
* **script:** support dependencies.dockutil command ([0dc1808](https://github.com/kc-workspace/dotfiles/commit/0dc1808dbdb13e61c73ab1a1cb8eca38a6d69576))
* **script:** update scripts and editorconfig for newline handling ([76b5768](https://github.com/kc-workspace/dotfiles/commit/76b57680200e375dd519ed53fe88debdbeaa9045))
...
* support new age with post-quantum mode ([944476c](https://github.com/kc-workspace/dotfiles/commit/944476c22847e6e80e7739005c8df4e1beb53a4c))
* **template:** add helper function for featureFlag render ([b45d5f6](https://github.com/kc-workspace/dotfiles/commit/b45d5f6af4cbb1505bc3010706e9113ec0770f1f))
* **template:** add helper function to check if a value is empty ([73810a1](https://github.com/kc-workspace/dotfiles/commit/73810a140df6d214f422e9a1c21e9cc738a88d5b))
* **template:** global/helpers/getData now support overrides (not merge) by _overrides field ([8c668fd](https://github.com/kc-workspace/dotfiles/commit/8c668fdb1880909598fb0dae5b38185a6c99da70))
...
* **helper:** when merge list, make sure item unique ([4365c60](https://github.com/kc-workspace/dotfiles/commit/4365c609d218a4a89641ad236315ef19e9d3dae7))
...
* **warprc:** support warp to personal, work, and home directory ([7d90509](https://github.com/kc-workspace/dotfiles/commit/7d90509c8020e9dabdf5c8346190290ac38db582))
...
* **data:** improve data structure on dependencies.mise ([6457cd6](https://github.com/kc-workspace/dotfiles/commit/6457cd609fb0dac7295a4d3b6440dc32e5763fd0))
...
* **data:** update syntax of featureFlags name ([d0a77a8](https://github.com/kc-workspace/dotfiles/commit/d0a77a89a8b69e798678819f6d574855fc711281))
...
* **script:** add autoremove option for mas in dependencies script ([870fb16](https://github.com/kc-workspace/dotfiles/commit/870fb166cb1026db24c1be613565ca5189e57724))
...
* sync target and source directories ([107ffdd](https://github.com/kc-workspace/dotfiles/commit/107ffdda8e3ff1bf07d7289041f81eea9b172b6a))
* sync target and source directories ([066360f](https://github.com/kc-workspace/dotfiles/commit/066360fc6c1bfa9d6e9a57d6476dcfbdfa1d33bb))
...
* **template:** add helpers fn and vars for data management ([91ad495](https://github.com/kc-workspace/dotfiles/commit/91ad49503358174fbb126f8d89bc00882987a53a))
* **template:** use age encrypt instead of op cli, significate performance booth! ([f40939a](https://github.com/kc-workspace/dotfiles/commit/f40939a24e0bcee1a6571d31883e0023ba8ec3f1))
